...
sudo scutil --set ComputerName "mbpr-dev"
#sudo scutil --set HostName "0x6D746873"
sudo scutil --set LocalHostName "mbpr-dev"
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.000000 0.589801 1.000000"
...
# Always confirm changes on close.
...
# Show Safari's tab bar by default
defaults write com.apple.Safari AlwaysShowTabBar -bool true

# Set some default Safari privacy defaults
...
# Standard dock icon for Activity Monitor
